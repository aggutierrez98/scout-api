...
- [ ] Implementar cron de scrapping de [cruz del sur](https://www.cruz-del-sur.org.ar/) diario, por la mañana. Para obtener nomina actualizada de scouts. Que este script avise tambien (a ADMINS) en caso de que haya scouts que esten en la app pero no en cruz del sur.
...
- [ ] Crear un bucket de S3 solo para desarrollo
- [ ] Mejorar docs de swagger. Agregar parametros y otros endpoints
...
- [x] Eliminar $extends de prismas y implementar arquitectura de mapper + DTO
